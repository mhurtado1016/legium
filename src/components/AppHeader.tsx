...
export function AppHeader({ left }: { left?: ReactNode }) {
  ...
  return (
    <Fragment>
      {/* position: fixed en vez de sticky: "overflow-x: hidden" en
          html/body (red de seguridad contra scroll horizontal, ver
          index.css) rompe position: sticky en varios navegadores —
          cualquier overflow != visible en un ancestro desactiva el
          sticky de sus descendientes, aunque sea solo en el eje X.
          fixed no depende del contexto de scroll de ningún ancestro, así
          que no le afecta. El div de abajo reserva el espacio que el
          header deja de ocupar en el flujo normal al salir de él. */}
      <header className="fixed top-0 inset-x-0 z-20 bg-paper/85 backdrop-blur-md border-b border-line/70">
